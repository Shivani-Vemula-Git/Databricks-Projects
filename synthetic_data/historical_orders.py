...
# LOAD MASTER DATA
# ============================================
script_dir = "/Workspace/Users/vemulashivaniwebsite@gmail.com/Databricks-Projects/synthetic_data/data/"
df_restaurants = pd.read_csv(os.path.join(script_dir, "restaurants.csv"))
df_customers = pd.read_csv(os.path.join(script_dir, "customers.csv"))
df_menu_items = pd.read_csv(os.path.join(script_dir, "menu_items.csv"))
...
def generate_historical_orders(num_orders=8000, months_back=6):
    ...
    # Save to CSV
    df_orders.to_csv(os.path.join(script_dir, "historical_orders.csv"), index=False)
